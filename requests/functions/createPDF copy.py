...
templatePath: str = '/requests/templates/Salisbury/PFT_Salisbury.docx'
temporaryPath: str = '/requests/templates/Salisbury/patient1.docx'
...
class docxManipulator():
    def __init__(self, templatePath: str, outputPath: str) -> None:
    ...
    def getTypes(self, location: str) -> list[str]:
        types: list[str] = []
        typesPath = f'{templateDir}{location}/'
    ...
    def replace(self, variables: str):
...
if __name__ == '__main__':
    ...
    print(docxPtr.getTypes('Salisbury'))
    """
    variables = docxPtr.getVariables()
    #print(variables)
