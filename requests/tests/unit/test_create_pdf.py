...
test_template_dir_no_locations: str = (
    "/requests/tests/test_templates_no_locations/"
)
...
expected_placeholders_return: list[list[str]] = [
    ...
    [
        ...
        "",
        "configuration",
        "emailTo:mark.bailey5@nhs.net",
    ],
]

test_placeholders: list[list[str]] = [
    ["Hospital address", "Hospital Road", "Hospital address"],
    ["GP name", "Dr Bob", "GP name"],
    ["GP address", "", "GP address"],
    ["now", "02/02/1945", "now"],
    ...
    [
        "Main body",
        "Pablo had a cold. He is already feeling better",
        "Main body",
    ],
...
class TestCreatePDF(unittest.TestCase):
    ...
    def test_check_template(self):
        ...
        self.assertEqual(
            template_pass_state,
            {
                "/requests/tests/test_templates/location_1/"
                "test_template_2_errors.docx": "FW",
                "/requests/tests/test_templates/location_1/"
                "test_template_1.docx": "..",
            },
        )
    ...
    def test_get_types(self):
        ...
        self.assertEqual(
            sorted(types), ["test_template_1", "test_template_2_errors"]
        )
    ...
    def test_get_placeholders(self):
        ...
        docxPtr = CreatePDF(test_template_dir, test_pdf_dir)
        placeholders = docxPtr.get_placeholders(
            "location_1", ["test_template_1"]
        )
        self.assertEqual(placeholders, expected_placeholders_return)

    def test_get_placeholders_check_no_duplicates(self):
        """
        Test no duplicates return, even if the same placeholders are
        seen in several templates
        """

        docxPtr = CreatePDF(test_template_dir, test_pdf_dir)
        placeholders = docxPtr.get_placeholders(
            "location_1", ["test_template_1", "test_template_1"]
        )
        self.assertEqual(placeholders, expected_placeholders_return)
    ...
    def test_sub_list_extract(self):
        ...
        function_return = docxPtr.sub_list_extract(
    ...
    def test_create(self):
        ...
        docxPtr = CreatePDF(test_template_dir, test_pdf_dir)
        function_return = docxPtr.create(
            "location_1",
            "test_template_1",
            test_placeholders,
            "Picasso_Pablo_12345",
    ...
    def test_create_no_placeholders_provided(self):
        ...
        with self.assertRaises(RuntimeError):
            docxPtr.create(
                "location_1", "test_template_1", [], "Picasso_Pablo_12345"
            )
